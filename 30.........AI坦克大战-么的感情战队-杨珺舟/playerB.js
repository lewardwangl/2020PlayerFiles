window.playerB = new (class PlayerControl {
  ...
  jzAttack() {
    ...
    // TODO 这里需要重写
    // if (currentTank.X > screenX*0.15 || currentTank.Y > 300) {
    ...
    //         console.log("这里要求上移动")
    //     } else if (this.#DIRECTION.DOWN != Bullet[1] && this.#DIRECTION.STOP == Bullet[5] && this.#DIRECTION.UP != Bullet[9]) {
    //         moveDirection = this.#DIRECTION.LEFT;
    //         console.log("这里要求右移动")
    //     }
    // }

    if (currentTank.X > screenX*0.45 || currentTank.Y > 300) {
      if (currentTank.Y > 300 && this.#DIRECTION.RIGHT != Bullet[1] && this.#DIRECTION.STOP == Bullet[2] && this.#DIRECTION.LEFT != Bullet[3]) {
          moveDirection = this.#DIRECTION.UP;
          console.log("这里要求上移动")
