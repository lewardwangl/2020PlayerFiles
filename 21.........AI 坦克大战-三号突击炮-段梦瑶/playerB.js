window.playerB = new (class PlayerControl {
    ...
    land() {
        ...
        var firedirectdis = 1                     // 根据最近坦克的距离大于firedirectdis*currentTankWH调整炮口
        var escapedir = 2                        // 逃跑指数，距离小于多少时逃跑
        ...
        if (moveDirection == undefined &&/* secruitylevel < 10 && */escapenum < 6) {
            ...
            //           moveDirection = this.#DIRECTION.LEFT;
            //         }/* else if (this.#DIRECTION.UP != Bullet[19] && this.#DIRECTION.DOWN != Bullet[7] && this.#DIRECTION.LEFT != Bullet[14] && this.#DIRECTION.STOP == Bullet[13]) {
            //         moveDirection = this.#DIRECTION.RIGHT;
            ...
            //       }*/
            //       } else {
            //         if (screenX > currentTankX &&!this.#isNearBoundary(currentTankX, currentTankY, this.#DIRECTION.RIGHT, currentTankWH) &&
            //             (this.#DIRECTION.UP != Bullet[19] && this.#DIRECTION.DOWN != Bullet[7] && this.#DIRECTION.LEFT != Bullet[14] && this.#DIRECTION.STOP == Bullet[13])) {
            //           moveDirection = this.#DIRECTION.RIGHT;
            //         }/* else if (!this.#isNearBoundary(currentTankX, currentTankY, this.#DIRECTION.DOWN, currentTankWH / 2) && this.#DIRECTION.DOWN != Bullet[5] && this.#DIRECTION.UP != Bullet[17] && this.#DIRECTION.RIGHT != Bullet[10] && this.#DIRECTION.STOP == Bullet[11]) {
            //         moveDirection = this.#DIRECTION.LEFT;
            //       }*/ else if (!this.#isNearBoundary(currentTankX, currentTankY, this.#DIRECTION.DOWN, currentTankWH) && cy > currentTankY && (this.#DIRECTION.RIGHT != Bullet[17] && this.#DIRECTION.STOP == Bullet[18] && this.#DIRECTION.LEFT != Bullet[19] && this.#DIRECTION.UP != Bullet[22])) {
            //           moveDirection = this.#DIRECTION.DOWN;
            //         }/* else if (cy > currentTankY && (this.#DIRECTION.RIGHT != Bullet[5] && this.#DIRECTION.STOP == Bullet[6] && this.#DIRECTION.LEFT != Bullet[7] && this.#DIRECTION.DOWN != Bullet[2])) {
    ...
    #avoidBullet(currentTankX, currentTankY, currentTankWH, Bullet, moveDirection) {
        if (this.#DIRECTION.DOWN == Bullet[6] || this.#DIRECTION.UP == Bullet[18]) {   //必须左右移动
            if (!this.#isNearBoundary(currentTankX, currentTankY, this.#DIRECTION.RIGHT, currentTankWH
                ...
                console.log("安全躲避移动左")
                moveDirection = this.#DIRECTION.LEFT;
            } else if ((currentTankX + currentTankWH) >= screenX) {
                moveDirection = this.#DIRECTION.LEFT
            }
        ...
        if (this.#DIRECTION.RIGHT == Bullet[11] || this.#DIRECTION.LEFT == Bullet[13]) { //必须垂直移动
            if (!this.#isNearBoundary(currentTankX, currentTankY, this.#DIRECTION.DOWN, currentTankWH
                ...
                console.log("安全躲避移动上")
                moveDirection = this.#DIRECTION.UP;
            } else if ((currentTankY + currentTankWH) >= screenY) {
                moveDirection = this.#DIRECTION.UP
            }
