    ...
    if (limitDirect != 1) {
      if (moveDirection == this.#DIRECTION.STOP) {
        if (!(closetColRLDis == 10000 && closetColUDDis == 10000)) {
          ...
          //if (MindisTank.id != 200) moveDirection = this.#getMaxDan_2(DanNearBa, Dan, 0.5)
          // 判断距离最近的坦克保持距离
          if (  undefined == MindisTank||MindisTank.id != 200) {
            if (moveDirection == this.#DIRECTION.STOP) {
          ...
          if (moveDirection == this.#DIRECTION.STOP) {
            ...
            if (undefined != MindisTank&&MindisTank.id == 200) lateEnemy = MindisTank
