  ...
  land() {
    ...
    if (moveDirection == undefined && escapenum < 4) {
      ...
      if (undefined != lateEnemy) {
        ...
        if (
          /*(disX > firedirectdis * currentTankWH || disY > firedirectdis * currentTankWH) ||*/ dis >=
        ...
        if (
          ...
          /*(disX < escapedir * currentTankWH || disY < escapedir * currentTankWH) ||*/ dis <
